...
Leg=legend({'$r=0.2$','$r=0.3$','$r=0.4$','$r=0.45$'},...
        'Interpreter','LaTeX');
Leg.AutoUpdate = 'off';
k = 1;
...
print  -depsc -r1000 chanfig2mdr3
% set(gcf,'Renderer','painters')
% print  -depsc -zbuffer  -r100 chanfig2mdr3a
print  -depsc -painters -r300 chanfig2mdr3
%%
